...
def play_002() -> dict:
    ...
    play = {
        "uid": "2025_wk20_LA-CHI_p002", "nfl_play_id": 40, "los_x": los, "ball_y": by,
...
def play_020() -> dict:
    ...
    play = {
        "uid": "2025_wk20_LA-CHI_p020", "nfl_play_id": 480, "los_x": los, "ball_y": by,
        "snap_frame": int(snap_t * FPS), "whistle_frame": int(whistle_t * FPS),
...
def play_073() -> dict:
    ...
    play = {
        "uid": "2025_wk20_LA-CHI_p073", "nfl_play_id": 1640, "los_x": los, "ball_y": by,
        "snap_frame": int(snap_t * FPS), "whistle_frame": int(whistle_t * FPS),
...
def main() -> int:
    records = {r["play_uid"]: r for r in (play_002(), play_020(), play_073())}
